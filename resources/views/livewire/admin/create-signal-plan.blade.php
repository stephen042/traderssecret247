<div class="col-xl-12 col-md-12 col-sm-12 mt-5">
    <div class="card">
        ...
        <form wire:submit="create_signal_plan">
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">Signal Strength</label>
                    <input type="number" wire:model.blur="plan_signal_strength" class="form-control"
