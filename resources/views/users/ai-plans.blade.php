                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <div>
                                <h1 class="page-title">Ai Plan <i class="fa fa-question-circle"
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Ai Plans</li>
                                </ol>
                            </div>
                        ...
                        <div class="row row-sm">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">ALL Ai_Plans Purchases</h3>
                                    </div>
                                    <div class="card-body">
