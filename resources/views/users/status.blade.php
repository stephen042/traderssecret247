                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <div>
                                <h1 class="page-title">Status Plans</h1>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('user_dashboard') }}">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Status Plans</li>
                                </ol>
                            </div>
                            ...
                            <div class="col">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Status Plans</h3>
                                    </div>
                                    <livewire:user.status-plans />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row row-sm">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">ALL Status Plans request</h3>
                                    </div>
                                    <div class="card-body">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @if ($plans_transaction->plan_transaction_status == 1)
                                                                    <span class="text-info fs-15 fw-semibold">
